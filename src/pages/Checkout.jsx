...
function Checkout() {
  ...
  const handleChange = (event) => {
    ...
    /*
     * Remove field error as the customer
     * starts editing it.
     */
    setErrors((current) => ({
      ...current,
  ...
  const handleSubmit = async (
    ...
    try {
       ...
       * IMPORTANT:
       *
       * We only send product ID and
       * quantity to Laravel.
       *
       * We do NOT send product prices
       * or totals as trusted values.
       */
      ...
      <section className="relative isolate overflow-hidden border-b border-white/5">
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
          ...
          <p className="mt-4 max-w-2xl leading-7 text-slate-400">
            ...
            Enter your contact and shipping
            information to place your Cash on
            Delivery order.
          </p>
        </div>
      </section>
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <CheckoutSection
              ...
              description="We'll use these details for your order confirmation and updates."
            >
